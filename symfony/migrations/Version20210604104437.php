...
final class Version20210604104437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_played (id INT AUTO_INCREMENT NOT NULL, player_id INT DEFAULT NULL, game_id INT NOT NULL, completion_time INT NOT NULL, INDEX IDX_11F862FC99E6F5DF (player_id), INDEX IDX_11F862FCE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
